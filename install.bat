...
if exist "%LLM_ROUTER_DIR%\install.bat" (
    echo Running LLM Router installation script...
    call "%LLM_ROUTER_DIR%\install.bat"
) else (
    echo Error: %LLM_ROUTER_DIR%\install.bat not found!
    exit /b 1
)
